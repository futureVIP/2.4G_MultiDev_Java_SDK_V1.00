...
public class DataConvert {
	...
	public static String convertToDecimalString(byte[] bytes, int startIndex,int length, char signal) {
	 ...
	 public static String convertToHexString(byte[] bytes, int startIndex, int length, char signal) {
         StringBuffer result = new StringBuffer();
         for (int index = 0; index < length && index < bytes.length; index++){
        	 result.append(DataConvert.bytesToHexString(bytes[index+startIndex]));
             if (index < length - 1){
                 result.append(signal);
             }
         }
	 ...
	 public static String convertToString(byte[] bytes, int startIndex, int length){
		 StringBuffer result = new StringBuffer();
         for (int index = 0; index < length && index<bytes.length; index++){
        	 result.append(DataConvert.bytesToHexString(bytes[index+ startIndex]));
         }
